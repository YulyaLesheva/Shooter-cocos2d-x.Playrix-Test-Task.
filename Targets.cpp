...
void Targets::physicTargetParams(float velocityLimit, int TAG, int categoryBitmask, 
	int collisionBitmask, int contactBitmask) 
{
...
void Targets::setPhysicTargetParams(float YvelocityLimit, int YTAG, int YcategoryBitmask, 
	int YcollisionBitmask, int YcontactBitmask)
{
